        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block">
                        <a href="{{ route('admin.install.webhook') }}" class="nav-link">Обновить webhoock</a>
                    </li>
                    <li class="nav-item d-none d-md-block">
                        <a href="{{ route('admin.update.geo') }}" class="nav-link">Обновить GEO</a>
                    </li>
                    <li class="nav-item d-none d-md-block">
                        <a href="{{ route('admin.test.mail') }}" class="nav-link">Проверить почту</a>
                    </li>
                </ul>
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{route('admin.servers.index')}}" class="nav-link active">
                                <i class="nav-icon bi bi-speedometer"></i>
                                <p>
                                    Сервера
                                </p>
